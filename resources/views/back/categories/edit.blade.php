...
<div class="page-wrapper" style="background-color:white;">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">ویرایش دسته بندی جدید</h3>
        </div>
    ...
    <form action="{{route('admin.categories.update',$category->id)}}"  class="container" dir="rtl" method="POST" style="text-align:right;padding-top:100px;padding-bottom:100px;">
        @csrf
    ...
    <div class="form-group">
        <label>ثبت</label>
        <button type="submit"  class="btn btn-success"> ویرایش دسته بندی</button>
    </div> 
    </form>
