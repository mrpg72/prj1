<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <li class="nav-small-cap"><a href="{{route('admin.index')}}">داشبرد</a></li>
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">صفحات <span class="label label-rouded label-themecolor pull-right">4</span></span></a>
                    <ul aria-expanded="false" class="collapse">
                    <li><a href="{{route('admin.users')}}">کاربران </a></li>
                        <li><a href="{{route('admin.categories')}}">دسته بندی ها</a></li>
                        <li><a href="{{route('admin.articles')}}">مطالب</a></li>
